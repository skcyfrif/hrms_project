<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item nav-category" style="font-size: 14px; font-weight: 700; color: #11e4a4;">Employee</li>
            ...
            <li class="nav-item mt-2">
                ...
                <ul class="collapse" id="leaveManagementMenu">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('leave.apply') }}" class="nav-link">Apply Leave</a>
                    </li>
                    <li class="nav-item">
            ...
            <li class="nav-item mt-2">
                ...
                <ul class="collapse" id="claimFormMenu">
                    <li class="nav-item">
                        <a href="{{ route('claim.form') }}" class="nav-link">Claim Form</a>
                    </li>
                    <li class="nav-item">
            ...
            <li class="nav-item mt-2">
                <a href="{{ route('employeee.myaccountUpdateRequests') }}" class="nav-link">
                    <i class="link-icon" data-feather="calendar"></i>
                    <span class="link-title">Account Update Status</span>
                </a>
            </li>
            <li class="nav-item mt-2">
                <a href="{{ route('employee.myUpdateRequests') }}" class="nav-link">
                    <i class="link-icon" data-feather="calendar"></i>
                    <span class="link-title">Profile Update Status</span>
                </a>
            </li>
            ...
            <li class="nav-item mt-2">
                ...
                <ul class="collapse" id="payrollandCompensationMenu">
                    <li class="nav-item">
                        <a href="{{ route('payslip') }}" class="nav-link">View Payslip</a>
                    </li>
            ...
            <li class="nav-item">
                <a href="{{ route('make.permanent') }}" class="nav-link">
