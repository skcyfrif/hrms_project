                ...
                <div class="row">
                    <div class="card shadow-sm border-0">
                        <div class="card-body p-5">
                            ...
                            <form method="post" action="{{ route('store.claim') }}" class="forms-sample"
                                id="employeeForm">
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <select class="form-control @error('manager_approval') is-invalid @enderror"
                                                ...
                                                <option value="Reporting Manager"
                                                    {{ old('manager_approval') == 'Reporting Manager' ? 'selected' : '' }}>
                                                    Reporting Manager</option>
                                                <option value="Others"
                                                    {{ old('manager_approval') == 'Others' ? 'selected' : '' }}>Others
                                                </option>
                                            </select>
