            ...
            <div class="row">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-5">
                        ...
                        <form method="post" action="{{ route('update.claim', $claim->id) }}" class="forms-sample">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="expense_description" name="expense_description"
                                           value="{{ $claim->expense_description }}">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control" id="receipt_attached" name="receipt_attached"
                                           value="{{ $claim->receipt_attached }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control @error('manager_approval') is-invalid @enderror" id="manager_approval" name="manager_approval">
                                        ...
                                        <option value="Reporting Manager" {{ ($claim->manager_approval ?? old('manager_approval')) == 'Reporting Manager' ? 'selected' : '' }}>Reporting Manager</option>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="approval_date" name="approval_date"
                                           value="{{ $claim->approval_date }}">
                                    @error('approval_date')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
