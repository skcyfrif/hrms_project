            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                                ...
                                <tr class="table-primary">
                                    ...
                                    <td><strong>₹
                                            {{ $def->basic_salary +
                                                ...
                                                $def->personal_pay +
                                                $def->other_allowance +
                                                $def->leave_travel_allowance }}</strong>
                                    </td>
                                    <td><strong>₹ 0</strong></td>
                                    <td><strong>Gross Deductions</strong></td>
                                    <td><strong>₹
                                            {{ $def->professional_tax + $def->esic + $def->advance }}</strong>
                                    </td>
                                </tr>
                        ...
                        <p class="fw-bold">Net Salary Payable (In Words): <strong>{{ $def->net_salary_payable }}</strong>
                        </p>
                        <br>
                        <br>
                        <br>
                        ...
                        <p class="mt-2 text-sm text-gray-600">Generated on: <span
