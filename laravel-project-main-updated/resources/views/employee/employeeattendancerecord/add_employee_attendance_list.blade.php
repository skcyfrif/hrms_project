            ...
            <div class="row">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-5">
                        ...
                        <form method="post" action="{{ route('store.employeeattendance') }}" class="forms-sample" id="employeeForm">
                            @csrf
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="check_in_time" class="form-label @error('check_in_time') is-invalid @enderror">Check In Time</label>
