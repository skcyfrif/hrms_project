...
<body>
    <div class="container mt-5">
        ...
        <div class="employee-details my-4">
            @php
                $fields = [
                    ...
                    'Work Location' => $payslip->work_location,
                    'Account Number' => $payslip->account_number,
                    'Standard Days' => $employee->standard_days,
                    'No Of Days Present' => $employee->no_of_working_day,
                    'LOP Days' => $employee->lop_days,
                ];
            @endphp
        ...
        <!-- Net Salary in Words -->
        <p class="fw-bold mt-3">Net Salary Payable : <strong>{{ $employee->net_salary_payables }}</strong></p>
