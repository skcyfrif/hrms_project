...
@section('hr_head')
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <a href="{{ route('add.hrmsalaries') }}" class="btn btn-inverse-info">Add Salary Details of Employee</a>
            </ol>
        </nav>
                                ...
                                <tbody>
                                    @foreach ($sals as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit.hrmsalaries', $item->id) }}"
                                                    class="btn btn-inverse-warning"> Edit</a>
                                                <a href="{{ route('delete.hrmsalaries', $item->id) }}"
                                                    class="btn btn-inverse-danger" id="delete"> Delete</a>
                                                <a href="{{ route('view.hrmsalaries', $item->id) }}"
