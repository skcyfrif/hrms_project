                ...
                <div class="row">
                    <div class="card shadow-sm border-0">
                        <div class="card-body p-5">
                            ...
                            <!-- Form Start -->
                            <form method="POST" action="{{ route('store.hrmsalaries') }}" class="forms-sample"
                                id="employeeForm">
                                @csrf
                                ...
                                <div class="form-step" id="step-1">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="doj"
                                                class="form-label @error('doj') is-invalid @enderror">DOJ</label>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="grade"
                                                class="form-label @error('grade') is-invalid @enderror">Grade</label>
                                        ...
                                        <div class="col-md-4">
                                            <label for="salary_for_the_month"
                                                class="form-label @error('salary_for_the_month') is-invalid @enderror">Salary
                                                For The Month</label>
                                            <input type="text" class="form-control" id="salary_for_the_month"
                                                name="salary_for_the_month">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-6">
                                                <label for="net_salary_payables"
                                                    class="form-label @error('net_salary_payables') is-invalid @enderror">Net
                                                    Salary Payable</label>
                                                <input type="text" class="form-control" id="net_salary_payables"
                                                    name="net_salary_payables" readonly>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="lop_days"
                                                class="form-label @error('lop_days') is-invalid @enderror">LOP
                                                Days</label>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="standard_days"
                                                class="form-label @error('standard_days') is-invalid @enderror">Standard
                                                Days</label>
                                            <input type="text" class="form-control" id="standard_days"
                                                name="standard_days" value="{{ old('standard_days') }}">
                                            @error('standard_days')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-step" id="step-2" style="display: none;">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-4">
                                            <label for="no_of_working_day"
                                                class="form-label @error('no_of_working_day') is-invalid @enderror">No. Of
                                                Working Day</label>
                                        ...
                                        <div class="col-md-4">
                                            <label for="total_leave_taken"
                                                class="form-label @error('total_leave_taken') is-invalid @enderror">Total
                                                Leave Taken</label>
    ...
    <script>
        $(document).ready(function() {
            function calculateNetSalary() {
                ...
                var totalAllowances = houseRentAllowance + conveyanceAllowance + lunchAllowance + medicalAllowance +
                    otherAllowance + leaveTravelAllowance + personalPay;
            ...
            $('#employee_id').on('change', function() {
                ...
                if (employee_id !== 'disabled') {
                    $.ajax({
                        ...
                        employee_id, // Call the employee details endpoint
                        method: 'GET',
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#house_rent_allowance').val(response.data
                                    .house_rent_allowance);
                                $('#conveyance_allowance').val(response.data
                                ...
                                $('#leave_travel_allowance').val(response.data
                                ...
                                $('#net_salary_payables').val(response.data
                                .net_salary_payables);
                                $('#lop_days').val(response.data.payroll.lop_days);
                                $('#standard_days').val(response.data.payroll.total_days);
                                $('#salary_for_the_month').val(response.data.payroll
                                    .gross_salary);
                                $('#no_of_working_day').val(response.data.payroll.days_present);
                                $('#total_leave_taken').val(
                                    response.data.payroll.lop_days + response.data.payroll
                                    .paid_leave_days + response.data.payroll.sick_leave_days
                                );
