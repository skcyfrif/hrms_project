    ...
    <div class="page-content">
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Attendance Status of Report Managers ({{ now()->year }})</h6>
                        <div class="table-responsive">

                            <form method="GET" action="{{ route('hr_head.rmattendances') }}" class="mb-4">
                                <div class="row">
                                    <div class="col-md-4">
                            ...
                            <table id="dataTableExample" class="table">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="9" class="text-center">No Reporting Manager attendance records
                                                found for
