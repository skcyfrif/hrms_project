        ...
        <tbody>
            @foreach ($claims as $key => $item)
                <tr>
                    ...
                    <td>
                        <a href="{{route('edit.hrheadclaim' , $item->id)}}" class="btn btn-inverse-warning"> Edit</a>
                        <a href="{{route('delete.hrheadclaim' , $item->id)}}" class="btn btn-inverse-danger" id="delete"> Delete</a>
                    </td>
