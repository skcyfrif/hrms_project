    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h5 class="text-center mb-4">Update Profile Approval Of All HR Manager</h5>
                                ...
                                <tbody>
                                    @forelse ($requests as $index => $request)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($status === 'hrpending')
                                                    <form action="{{ route('hr.profile.approve', $request->id) }}"
                                                        method="POST" style="display:inline-block">
                                                        @csrf
                                                        <button type="submit"
                                                            class="btn btn-sm btn-success">Approve</button>
                                                    </form>
                                                    <form action="{{ route('hr.profile.reject', $request->id) }}"
                                                        method="POST" style="display:inline-block">
                                                        @csrf
