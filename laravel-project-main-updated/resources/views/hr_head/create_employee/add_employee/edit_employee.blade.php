                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="employee_id" name="employee_id"
                                                value="{{ $manager->employee_id }}" readonly>
                                            @error('employee_id')
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="file" class="form-control" id="photo" name="photo"
                                                value="{{ $manager->photo }}" required>
                                            @error('photo')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                            @if (isset($manager->photo))
                                                <div class="mt-2">
                                                    <img src="{{ asset($manager->photo) }}" alt="Employee Photo"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="phone_number" name="phone_number"
                                                value="{{ $manager->phone_number }}" required>
                                            @error('phone_number')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control @error('gender') is-invalid @enderror"
                                                ...
                                                <option value="male"
                                                    {{ old('gender', $manager->gender) == 'male' ? 'selected' : '' }}>Male
                                                </option>
                                                <option value="female"
                                                    {{ old('gender', $manager->gender) == 'female' ? 'selected' : '' }}>
                                                    Female</option>
                                            </select>
                                            @error('gender')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                        ...
                                        <textarea class="form-control" id="permanent_address" name="permanent_address" rows="4" required>{{ $manager->permanent_address }}</textarea>
                                        ...
                                        <div class="col-md-4">
                                            <label for="permanent_address_line1"
                                                class="form-label @error('permanent_address_line1') is-invalid @enderror">Permanent
                                                Address Line 1</label>
                                            <input type="text" class="form-control" id="permanent_address_line1"
                                                name="permanent_address_line1"
                                                value="{{ old('permanent_address_line1', $manager->permanent_address_line1) }}"
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="permanent_address_line2"
                                                ...
                                                value="{{ old('permanent_address_line2', $manager->permanent_address_line2) }}"
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="permanent_city"
                                                name="permanent_city"
                                                value="{{ old('permanent_city', $manager->permanent_city) }}" required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="permanent_district"
                                                ...
                                                value="{{ old('permanent_district', $manager->permanent_district) }}"
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="permanent_state"
                                                ...
                                                value="{{ old('permanent_state', $manager->permanent_state) }}" required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="permanent_pin"
                                                name="permanent_pin"
                                                value="{{ old('permanent_pin', $manager->permanent_pin) }}" required>
                                            @error('permanent_pin')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="current_address_line1"
                                                ...
                                                value="{{ old('current_address_line1', $manager->current_address_line1) }}"
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="current_address_line2"
                                                ...
                                                value="{{ old('current_address_line2', $manager->current_address_line2) }}"
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="current_city"
                                                name="current_city"
                                                value="{{ old('current_city', $manager->current_city) }}" required>
                                            @error('current_city')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="current_district"
                                                ...
                                                value="{{ old('current_district', $manager->current_district) }}"
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="current_state"
                                                name="current_state"
                                                value="{{ old('current_state', $manager->current_state) }}" required>
                                            @error('current_state')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="current_pin"
                                                name="current_pin"
                                                value="{{ old('current_pin', $manager->current_pin) }}" required>
                                            @error('current_pin')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <textarea class="form-control" id="current_address" name="current_address" rows="4" required>{{ $manager->current_address }}</textarea>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea class="form-control" id="emergency_contact" name="emergency_contact" rows="4" required>{{ $manager->emergency_contact }}</textarea>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="designation"
                                                name="designation" value="{{ $manager->designation }}">
                                            @error('designation')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="work_location"
                                                name="work_location" value="{{ $manager->work_location }}" required>
                                            @error('work_location')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" id="employment_type" name="employment_type"
                                                ...
                                                <option value="permanent"
                                                    {{ $manager->employment_type == 'permanent' ? 'selected' : '' }}>
                                                    Full-time</option>
                                                <option value="non_permanent"
                                                    {{ $manager->employment_type == 'non_permanent' ? 'selected' : '' }}>
                                                    Intern</option>
                                            </select>
                                ...
                                <div class="form-step" id="step-2" style="display: none;">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="account_number"
                                                name="account_number" value="{{ $manager->account_number }}" required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="ifsc_code" name="ifsc_code"
                                                value="{{ $manager->ifsc_code }}" required>
                                            @error('ifsc_code')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="bank_name" name="bank_name"
                                                value="{{ $manager->bank_name }}" required>
                                            @error('bank_name')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="branch_name"
                                                name="branch_name" value="{{ $manager->branch_name }}" required>
                                            @error('branch_name')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" id="types" name="types" required>
                                                <option value="salary"
                                                    {{ $manager->types == 'salary' ? 'selected' : '' }}>Salary</option>
                                                <option value="stipend"
                                                    {{ $manager->types == 'stipend' ? 'selected' : '' }}>Stipend</option>
                                                <option value="consolidated_ammount"
                                                    {{ $manager->types == 'consolidated_ammount' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-4 stipend-fields" style="display: none;">
                                        ...
                                        <input type="text" class="form-control" id="consolidated_pay" name="consolidated_pay"
                                               value="{{ $manager->consolidated_pay }}">
                                    ...
                                    <div class="col-md-4 consolidated-fields" style="display: none;">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" id="pay_cycle" name="pay_cycle" required>
                                                <option value="monthly"
                                                    {{ $manager->pay_cycle == 'monthly' ? 'selected' : '' }}>Monthly
                                                </option>
                                                <option value="weekly"
                                                    {{ $manager->pay_cycle == 'weekly' ? 'selected' : '' }}>Weekly</option>
                                                <option value="bi-weekly"
                                                    {{ $manager->pay_cycle == 'bi-weekly' ? 'selected' : '' }}>Bi-weekly
                                                </option>
                                            </select>
                                            @error('pay_cycle')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="total_leave_allowed"
                                                name="total_leave_allowed" value="{{ $manager->total_leave_allowed }}">
                                        ...
                                        <div class="col-md-4 salary-fields">
                                            ...
                                            <input type="text" class="form-control" id="basic_salary"
                                                name="basic_salary" value="{{ $manager->basic_salary }}" required>
                                            @error('basic_salary')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-4 salary-fields">
                                            ...
                                            <input type="text" class="form-control" id="house_rent_allowance"
                                                name="house_rent_allowance" value="{{ $manager->house_rent_allowance }}"
                                                required>
                                        ...
                                        <div class="col-md-4 salary-fields">
                                            ...
                                            <input type="text" class="form-control" id="conveyance_allowance"
                                                name="conveyance_allowance" value="{{ $manager->conveyance_allowance }}"
                                                required>
                                        ...
                                        <div class="col-md-4 salary-fields">
                                            ...
                                            <input type="text" class="form-control" id="lunch_allowance"
                                                name="lunch_allowance" value="{{ $manager->lunch_allowance }}" required>
                                        ...
                                        <div class="col-md-4 salary-fields">
                                            ...
                                            <input type="text" class="form-control" id="personal_pay"
                                                name="personal_pay" value="{{ $manager->personal_pay }}" required>
                                            @error('personal_pay')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4 salary-fields">
                                            ...
                                            <input type="text" class="form-control" id="medical_allowance"
                                                name="medical_allowance" value="{{ $manager->medical_allowance }}"
                                                required>
                                        ...
                                        <div class="col-md-4 salary-fields">
                                            ...
                                            <input type="text" class="form-control" id="other_allowance"
                                                name="other_allowance" value="{{ $manager->other_allowance }}" required>
                                        ...
                                        <div class="col-md-4 salary-fields">
                                            ...
                                            <input type="text" class="form-control" id="leave_travel_allowance"
                                                ...
                                                value="{{ $manager->leave_travel_allowance }}" required>
                                    ...
                                    <div class="row mb-4 salary-fields">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="total_ammount"
                                                name="total_ammount" value="{{ $manager->total_ammount }}" readonly>
                                            @error('total_ammount')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-4 salary-fields">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="professional_tax"
                                                name="professional_tax" value="{{ $manager->professional_tax }}"
                                                required>
                                        ...
                                        <input type="text" class="form-control" id="advance" name="advance"
                                               value="{{$manager->advance}}" required>
                                        @error('advance')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div> --}}
                                    ...
                                    <div class="row mb-4 salary-fields">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="net_salary_payable"
                                                name="net_salary_payable" value="{{ $manager->net_salary_payable }}"
                                                readonly>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" id="user_role" name="user_role" required>
                                                {{-- <option value="head" {{  $manager->user_role == 'head' ? 'selected' : '' }}>Hr Head</option> --}}
                                                <option value="manager"
                                                    {{ $manager->user_role == 'manager' ? 'selected' : '' }}>Hr Manager
                                                </option>
                                                {{-- <option value="user" {{  $manager->user_role == 'user' ? 'selected' : '' }}>User</option> --}}
                                            </select>
                                            @error('user_role')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" id="username" name="username" required>
                                                {{-- <option value="head" {{  $manager->username == 'head' ? 'selected' : '' }}>Hr Head</option> --}}
                                                <option value="manager"
                                                    {{ $manager->username == 'manager' ? 'selected' : '' }}>Hr Manager
                                                </option>
                                                {{-- <option value="user" {{  $manager->username == 'user' ? 'selected' : '' }}>User</option> --}}
                                            </select>
                                            @error('username')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
