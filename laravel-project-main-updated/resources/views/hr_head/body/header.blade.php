                ...
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    ...
                    <ul class="list-unstyled p-1">
                        <li class="dropdown-item py-2">
                            <a href="{{route('hrhead.profile')}}" class="text-body ms-0">
                                <i class="me-2 icon-md" data-feather="user"></i>
                                <span>Profile</span>
                            </a>
                        </li>
                        <li class="dropdown-item py-2">
                            <a href="{{route('hrhead.change.password')}}" class="text-body ms-0">
                        ...
                        <li class="dropdown-item py-2">
                            <a href="{{route('hrhead.logout')}}" class="text-body ms-0">
