...
<div class="page-content">
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <a href="{{route('add.rmclaim')}}" class="btn btn-inverse-info">Add Expense Details of Reporting manager</a>
        ...
        <tbody>
            @foreach ($claims as $key => $item)
                <tr>
                    ...
                    <td>
                        <a href="{{route('edit.rmclaim' , $item->id)}}" class="btn btn-inverse-warning"> Edit</a>
                        <a href="{{route('delete.rmclaim' , $item->id)}}" class="btn btn-inverse-danger" id="delete"> Delete</a>
                    </td>
