            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-title">Update Report Manager Profile</h6>

                        <form method="post" action="{{route('reportmanager.profile.store')}}" class="forms-sample" enctype="multipart/form-data">
                            @csrf
