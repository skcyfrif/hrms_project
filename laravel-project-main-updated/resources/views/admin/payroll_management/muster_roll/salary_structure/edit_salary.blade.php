                ...
                <div class="row">
                    <div class="card shadow-sm border-0">
                        <div class="card-body p-5">
                            ...
                            <!-- Form Start -->
                            <form method="POST" action="{{ route('update.hrsalaries', $sal->id) }}" class="forms-sample"
                                id="employeeForm">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="account_number"
                                                name="account_number" value="{{ $sal->account_number }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="branch_name"
                                                name="branch_name" value="{{ $sal->branch_name }}" required>
                                            @error('branch_name')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="basic_salary"
                                                name="basic_salary" value="{{ $sal->basic_salary }}" required>
                                            @error('basic_salary')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <label for="salary_for_the_month" class="form-label">Salary For The
                                                Month</label>
                                            <input type="text" class="form-control" id="salary_for_the_month"
                                                name="salary_for_the_month" value="{{ $sal->salary_for_the_month }}"
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="house_rent_allowance"
                                                name="house_rent_allowance" value="{{ $sal->house_rent_allowance }}"
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="conveyance_allowance"
                                                name="conveyance_allowance" value="{{ $sal->conveyance_allowance }}"
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="lunch_allowance"
                                                name="lunch_allowance" value="{{ $sal->lunch_allowance }}" required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="medical_allowance"
                                                name="medical_allowance" value="{{ $sal->medical_allowance }}" required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="other_allowance"
                                                name="other_allowance" value="{{ $sal->other_allowance }}" required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="leave_travel_allowance"
                                                name="leave_travel_allowance" value="{{ $sal->leave_travel_allowance }}"
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="personal_pay"
                                                name="personal_pay" value="{{ $sal->personal_pay }}" required>
                                            @error('personal_pay')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="professional_tax"
                                                name="professional_tax" value="{{ $sal->professional_tax }}" required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="net_salary_payables"
                                                name="net_salary_payables" value="{{ $sal->net_salary_payables }}"
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="standard_days"
                                                name="standard_days" value="{{ $sal->standard_days }}" required>
                                            @error('standard_days')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-step" id="step-2" style="display: none;">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="no_of_working_day"
                                                name="no_of_working_day" value="{{ $sal->no_of_working_day }}">
                                            ...
                                            <div class="col-md-4">
                                                <label for="total_leave_taken" class="form-label">Total Leave
                                                    Taken</label>
                                                <input type="text" class="form-control" id="total_leave_taken"
                                                    name="total_leave_taken" value="{{ $sal->total_leave_taken }}">
