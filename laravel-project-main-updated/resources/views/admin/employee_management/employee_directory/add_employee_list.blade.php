            ...
            <div class="row">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-5">
                        ...
                        <!-- Form Start -->
                        <form method="POST" action="{{ route('store.subu') }}" class="forms-sample" id="employeeForm" enctype="multipart/form-data">
                            {{-- <form action="{{ route('subu.store') }}" method="POST" enctype="multipart/form-data"> --}}
                            @csrf
                            ...
                            <div class="form-step" id="step-1">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label for="dob" class="form-label @error('dob') is-invalid @enderror">Date of Birth</label>
                                    ...
                                    <div class="col-md-4">
                                        <label for="permanent_address_line1" class="form-label @error('permanent_address_line1') is-invalid @enderror">Address Line 1</label>
                                        <input type="text" class="form-control" id="permanent_address_line1" name="permanent_address_line1" value="{{ old('permanent_address_line1') }}">
                                    ...
                                    <div class="col-md-4">
                                        <label for="permanent_address_line2" class="form-label @error('permanent_address_line2') is-invalid @enderror">Address Line 2</label>
                                        <input type="text" class="form-control" id="permanent_address_line2" name="permanent_address_line2" value="{{ old('permanent_address_line2') }}">
                                    ...
                                    <div class="col-md-4">
                                        <label for="permanent_city" class="form-label @error('permanent_city') is-invalid @enderror">City</label>
                                        <input type="text" class="form-control" id="city" name="permanent_city" value="{{ old('permanent_city') }}">
                                    ...
                                    <div class="col-md-4">
                                        <label for="permanent_district" class="form-label @error('permanent_district') is-invalid @enderror">District</label>
                                        <input type="text" class="form-control" id="permanent_district" name="permanent_district" value="{{ old('permanent_district') }}">
                                    ...
                                    <div class="col-md-4">
                                        <label for="permanent_state" class="form-label @error('permanent_state') is-invalid @enderror">State</label>
                                        <input type="text" class="form-control" id="permanent_state" name="permanent_state" value="{{ old('permanent_state') }}">
                                    ...
                                    <div class="col-md-4">
                                        <label for="permanent_pin" class="form-label @error('permanent_pin') is-invalid @enderror">Pin Code</label>
                                        <input type="text" class="form-control" id="permanent_pin" name="permanent_pin" value="{{ old('permanent_pin') }}">
                                        @error('permanent_pin')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="current_address_line1" name="current_address_line1" value="{{ old('current_address_line1') }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="current_address_line2" name="current_address_line2" value="{{ old('current_address_line2') }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="current_city" name="current_city" value="{{ old('current_city') }}">
                                        @error('current_city')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="current_district" name="current_district" value="{{ old('current_district') }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="current_state" name="current_state" value="{{ old('current_state') }}">
                                        @error('current_state')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="current_pin" name="current_pin" value="{{ old('current_pin') }}">
                                        @error('current_pin')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <label for="emergency_contact" class="form-label @error('emergency_contact') is-invalid @enderror">Emergency Contact</label>
                                        <textarea class="form-control" id="emergency_contact" name="emergency_contact" value="{{ old('emergency_contact') }}"></textarea>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label for="work_location" class="form-label @error('work_location') is-invalid @enderror">Work Location</label>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label for="doj" class="form-label @error('doj') is-invalid @enderror">Date of Joining</label>
                            ...
                            <div class="form-step" id="step-2" style="display: none;">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                        <label for="total_leave_allowed" class="form-label @error('total_leave_allowed') is-invalid @enderror">Total Leave Allowed</label>
                                        <input type="text" class="form-control" id="total_leave_allowed" name="total_leave_allowed" value="{{ old('total_leave_allowed') }}">
                                ...
                                <div class="row mb-4 salary-fields">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="total_ammount" name="total_ammount" value="{{ old('total_ammount') }}" readonly>
                                        @error('total_ammount')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4 salary-fields">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="net_salary_payable" name="net_salary_payable" value="{{ old('net_salary_payable') }}" readonly>
