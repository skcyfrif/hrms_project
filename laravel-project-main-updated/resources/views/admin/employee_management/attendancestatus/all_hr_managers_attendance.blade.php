    ...
    <div class="page-content">
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Attendance Status Of All HR Managers ({{ now()->year }})</h6>
                        <div class="table-responsive">

                            <form method="GET" action="{{ route('admin.hr_managersattendances') }}" class="mb-4">
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-auto">
                                        <a href="{{ route('admin.hr_managersattendances') }}"
                            ...
                            <div class="mb-3 text-end">
                                <a href="{{ route('admin.download.hrmanagerattendances', ['month' => $selectedMonth]) }}"
                            ...
                            <div class="mb-3 text-end">
                                <a href="{{ route('admin.download.hrmanagerattendances', ['type' => 'monthly', 'month' => $currentMonth]) }}"
                                    class="btn btn-success">
                                ...
                                <table id="dataTableExample" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="9" class="text-center">No HR Head attendance records found
                                                    for
