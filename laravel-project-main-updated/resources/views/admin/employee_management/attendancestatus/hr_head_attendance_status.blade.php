                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <form method="GET" action="{{ route('admin.hr_headsattendances') }}" class="mb-4">
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-auto">
                                        <a href="{{ route('admin.hr_headsattendances') }}"
                            ...
                            <div class="mb-3 text-end">
                                <a href="{{ route('admin.download.hrheadattendances', ['month' => $selectedMonth]) }}"
                            ...
                            <div class="mb-3 text-end">
                                <a href="{{ route('admin.download.hrheadattendances', ['type' => 'monthly', 'month' => $currentMonth]) }}"
                                    class="btn btn-success">
