...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Claim Status Of All HR Heads</h6>

                    <form method="GET" action="{{ route('admin.hr_headsclaim') }}" class="mb-3">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 d-flex align-items-end">
                                ...
                                <a href="{{ route('admin.hr_headsclaim') }}" class="btn btn-secondary">Reset</a>
                            </div>
                        </div>
                    </form>
