    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h5 class="text-center mb-4">Update Profile Approval Of All HR Heads</h5>
                                ...
                                <tbody>
                                    @forelse ($requests as $index => $request)
                                        <tr>
                                            ...
                                            <td>
                                                @php $status = strtolower($request->admin_status); @endphp
                                            ...
                                            <td>
                                                @if ($status === 'adminpending')
                                                    <form action="{{ route('admin.profile.approve', $request->id) }}"
                                                        method="POST" style="display:inline-block">
                                                        @csrf
                                                        <button type="submit"
                                                            class="btn btn-sm btn-success">Approve</button>
                                                    </form>
                                                    <form action="{{ route('admin.profile.reject', $request->id) }}"
                                                        method="POST" style="display:inline-block">
                                                        @csrf
