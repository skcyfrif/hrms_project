    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h5 class="text-center">Claim approval Of All HR Heads</h5>
                                    ...
                                    @foreach ($claims as $key => $claim)
                                        <tr>
                                            ...
                                            @elseif($claim->status == 'reject')
                                                ...
                                                <a href="{{ route('approve.claimss', $claim->id) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="rejectClaimForm" method="POST" action="{{ route('reject.claimss.submit') }}">
                        @csrf
