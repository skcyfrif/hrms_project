        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="GET" action="{{ route('admin.employeeleaves') }}" class="mb-4">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <tbody>
                                @foreach ($hrHeads as $key => $head)
                                    <tr>
                                        ...
                                        <td>{{ $head->leave?->leave_from ?? '- - -' }}</td>
                                        <td>{{ $head->leave?->leave_to ?? '- - -' }}</td>
                                        <td>
                                            @if ($head->leave->rm_status === 'rmapprove')
                                               <span class="badge bg-success fs-6 px-3 py-2">Approved</span>


                                            @elseif($head->leave->rm_status === 'rmreject')
