                ...
                <div class="row">
                    <div class="card shadow-sm border-0">
                        <div class="card-body p-5">
                            ...
                            <form method="post" action="{{ route('update.hrmclaim', $claim->id) }}" class="forms-sample">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4">
                                        <label for="hrhead_approval" class="form-label">Approved By</label>
                                        <select class="form-control @error('hrhead_approval') is-invalid @enderror"
                                            id="hrhead_approval" name="hrhead_approval">
                                            <option value="">Select</option>
                                            <option value="hrhead"
                                                {{ ($claim->hrhead_approval ?? old('hrhead_approval')) == 'hrhead' ? 'selected' : '' }}>
                                                Hr Head</option>
                                            <option value="Others"
                                                {{ ($claim->hrhead_approval ?? old('hrhead_approval')) == 'Others' ? 'selected' : '' }}>
                                                Others</option>
                                        </select>
