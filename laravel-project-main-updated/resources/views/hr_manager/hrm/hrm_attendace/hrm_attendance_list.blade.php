...
@section('hr_manager')
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <a href="{{ route('add.hrmattendance') }}" class="btn btn-inverse-info">Add Attendance of Hr Manager</a>
            </ol>
        </nav>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <form method="GET" action="{{ route('hrm.attendance.list') }}" class="row mb-4">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3 align-self-end">
                                    ...
                                    <a href="{{ route('hrm.attendance.list') }}" class="btn btn-secondary">Reset</a>
                                </div>
                            </form>
                                    ...
                                    @foreach ($atens as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('delete.hrmattendance', $item->id) }}"
