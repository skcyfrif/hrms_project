                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <form method="GET" action="{{ route('hrm.employee.attendance') }}" class="mb-4">
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-auto">
                                        <a href="{{ route('hrm.employee.attendance') }}" class="btn btn-secondary">Reset</a>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="mb-3 text-end">
                                <a href="{{ route('hrm.download.employeeattendance', ['month' => $selectedMonth]) }}"
                            ...
                            <div class="mb-3 text-end">
                                <a href="{{ route('hrm.download.employeeattendance', ['type' => 'monthly', 'month' => $currentMonth]) }}"
                                    class="btn btn-success">
