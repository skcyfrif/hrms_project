            ...
            <div class="row">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-5">
                        ...
                        <form method="post" action="{{ route('update.hrmanagerleave', $test->id) }}" class="forms-sample">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="reason" name="reason" required>
                                        ...
                                        <option value="PL" {{ $test->reason == 'PL' ? 'selected' : '' }}>PL (Privilege Leave)</option>
                                        <option value="Seek Leave" {{ $test->reason == 'Seek Leave' ? 'selected' : '' }}>Seek Leave</option>
                                        <option value="Casual Leave" {{ $test->reason == 'Casual Leave' ? 'selected' : '' }}>Casual Leave</option>
                                        <option value="LOP" {{ $test->reason == 'LOP' ? 'selected' : '' }}>LOP (Loss of Pay)</option>
                                        <option value="Transit Leave" {{ $test->reason == 'Transit Leave' ? 'selected' : '' }}>Transit Leave</option>
                                        <option value="Others" {{ $test->reason == 'Others' ? 'selected' : '' }}>Others</option>
                                    </select>
                                    @error('reason')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
