...
<div class="page-content">
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <a href="{{route('add.apply')}}" class="btn btn-inverse-info">apply job</a>
        </ol>
    </nav>
...
<div class="card">
  <div class="card-body">
    <h6 class="card-title">All Apply</h6>
                ...
                @foreach ($tests as $key => $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('delete.apply' , $item->id)}}" class="btn btn-inverse-danger" id="delete"> Delete</a>
                        </td>
                    </tr>
                @endforeach
        </tbody>
