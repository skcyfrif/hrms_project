                ...
                <div class="row">
                    <div class="card shadow-sm border-0">
                        <div class="card-body p-5">
                            <h6 class="card-title text-center mb-4">Add or Edit Employee Details</h6>

                            <!-- Form Start -->
                            <form method="POST" action="{{ route('store.employee') }}" class="forms-sample" id="employeeForm"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="phone_number"
                                                ...
                                                Number</label>
                                            <input type="int" class="form-control" id="phone_number" name="phone_number"
                                        ...
                                        <textarea class="form-control" id="current_address" name="current_address">{{ old('current_address') }}</textarea>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="employment_type" class="form-label @error('employment_type') is-invalid @enderror">Employment Type</label>
                                            <select class="form-control @error('employment_type') is-invalid @enderror" id="employment_type" name="employment_type">
                                                <option value="">- - - Select - - -</option>
                                                <option value="permanent" {{ old('employment_type') == 'permanent' ? 'selected' : '' }}>Full-time</option>
                                                <option value="non_permanent" {{ old('employment_type') == 'non_permanent' ? 'selected' : '' }}>Intern</option>
                                            </select>
                                ...
                                <div class="form-step" id="step-2" style="display: none;">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-4">
                                            <label for="types" class="form-label @error('types') is-invalid @enderror">Types</label>
                                            <select class="form-control @error('types') is-invalid @enderror" id="types" name="types">
                                                <option value="">-- Select --</option>
                                                <option value="salary" {{ old('types') == 'salary' ? 'selected' : '' }}>Salary</option>
                                                <option value="stipend" {{ old('types') == 'stipend' ? 'selected' : '' }}>Stipend</option>
                                                <option value="consolidated_ammount" {{ old('types') == 'consolidated_ammount' ? 'selected' : '' }}>Consolidated Ammount</option>
                                            </select>
                                            @error('types')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4 stipend-fields" style="display: none;">
                                        <label for="stipend_allowance" class="form-label @error('stipend_allowance') is-invalid @enderror">Stipend Allowance</label>
                                        <input type="text" class="form-control" id="stipend_allowance" name="stipend_allowance" value="{{ old('stipend_allowance') }}">
                                        @error('stipend_allowance')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>

                                    <div class="col-md-4 stipend-fields" style="display: none;">
                                        <label for="total_stipend_ammount" class="form-label @error('total_stipend_ammount') is-invalid @enderror">Total Ammount</label>
                                        <input type="text" class="form-control" id="total_stipend_ammount" name="total_stipend_ammount" value="{{ old('total_stipend_ammount') }}" readonly>
                                        @error('total_stipend_ammount')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div> --}}

                                        {{-- java script for Stipend --}}
                                        {{-- <script>
                                        document.addEventListener('DOMContentLoaded', function() {
                                            // Select input elements for stipend
                                            const stipendAmount = document.getElementById('stipend_amount');
                                            const stipendAllowance = document.getElementById('stipend_allowance');
                                            const totalStipendAmount = document.getElementById('total_stipend_ammount');

                                            // Function to calculate the total stipend amount
                                            function calculateTotalStipendAmount() {
                                                const amount = parseFloat(stipendAmount.value) || 0;
                                                const allowance = parseFloat(stipendAllowance.value) || 0;

                                                // Set the total stipend amount value
                                                totalStipendAmount.value = amount + allowance;
                                            }

                                            // Add event listeners to the input fields to recalculate total stipend when the user types
                                            stipendAmount.addEventListener('input', calculateTotalStipendAmount);
                                            stipendAllowance.addEventListener('input', calculateTotalStipendAmount);
                                        });
                                    </script> --}}

                                        {{-- End of java script for Stipend --}}

                                        <!-- New Fields for Consolidated Amount -->
                                        {{-- <div class="col-md-4 consolidated-fields" style="display: none;">
                                        <label for="consolidated_amount" class="form-label @error('consolidated_amount') is-invalid @enderror">Consolidated Amount</label>
                                        <input type="text" class="form-control" id="consolidated_amount" name="consolidated_amount" value="{{ old('consolidated_amount') }}">
                                        @error('consolidated_amount')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 consolidated-fields" style="display: none;">
                                        <label for="consolidated_allowance" class="form-label @error('consolidated_allowance') is-invalid @enderror">Consolidated Allowance</label>
                                        <input type="text" class="form-control" id="consolidated_allowance" name="consolidated_allowance" value="{{ old('consolidated_allowance') }}">
                                        @error('consolidated_allowance')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>

                                    <div class="col-md-4 consolidated-fields" style="display: none;">
                                        <label for="total_consolidated_ammount" class="form-label @error('total_consolidated_ammount') is-invalid @enderror">Total Ammount</label>
                                        <input type="text" class="form-control" id="total_consolidated_ammount" name="total_consolidated_ammount" value="{{ old('total_consolidated_ammount') }}" readonly>
                                        @error('total_consolidated_ammount')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div> --}}

                                        {{-- java script for Consolidated Amount --}}

                                        {{-- <script>
                                        document.addEventListener('DOMContentLoaded', function() {
                                            // Select input elements
                                            const consolidatedAmount = document.getElementById('consolidated_amount');
                                            const consolidatedAllowance = document.getElementById('consolidated_allowance');
                                            const totalAmount = document.getElementById('total_consolidated_ammount');

                                            // Function to calculate the total amount
                                            function calculateTotalAmount() {
                                                const amount = parseFloat(consolidatedAmount.value) || 0;
                                                const allowance = parseFloat(consolidatedAllowance.value) || 0;

                                                // Set the total amount value
                                                totalAmount.value = amount + allowance;
                                            }

                                            // Add event listeners to the input fields to recalculate total when the user types
                                            consolidatedAmount.addEventListener('input', calculateTotalAmount);
                                            consolidatedAllowance.addEventListener('input', calculateTotalAmount);
                                        });
                                    </script> --}}

                                        {{-- End of java script for Consolidated Amount --}}



                                        <div class="col-md-4">
                                            <label for="pay_cycle" class="form-label @error('pay_cycle') is-invalid @enderror">Pay Cycle</label>
                                            <select class="form-control @error('pay_cycle') is-invalid @enderror" id="pay_cycle" name="pay_cycle">
                                                <option value="">- - - Select - - -</option>
                                                ...
                                                <option value="bi-weekly" {{ old('pay_cycle') == 'bi-weekly' ? 'selected' : '' }}>Bi-weekly</option>
                                            </select>
                                            @error('pay_cycle')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="row mb-4 salary-fields">
                                            ...
                                            <div class="col-md-6 salary-fields">
                                                ...
                                                <input type="text" class="form-control" id="esic" name="esic"
                                                    value="{{ old('esic') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                                @error('esic')
                                                    <div class="text-danger mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control @error('user_role') is-invalid @enderror" id="user_role" name="user_role">
                                                    ...
                                                    <option value="reportmanager" {{ old('user_role') == 'reportmanager' ? 'selected' : '' }}>Report Manager</option>
                                                </select>
                                                @error('user_role')
                                                    <div class="text-danger mt-1">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-4" id="assigned_to_field" style="display: none;">
                                                <label for="assigned_to"
                                                    class="form-label @error('assigned_to') is-invalid @enderror">Assigned
                                                    To</label>
                                            ...
                                            {{-- JavaScript to show/hide fields based on User Role --}}
                                            <script>
                                                document.getElementById('user_role').addEventListener('change', function() {
                                                    ...
                                                    // Hide assigned_to field initially
                                                ...
                                                // Function to fetch the report managers for the logged-in HR manager
                                                function fetchAssignedToManagers() {
                                                    fetch('/get-report-managers') // This route will trigger the getReportManagers method
                                                        .then(response => {
                                                            if (!response.ok) {
                                                        ...
                                                        .then(data => {
                                                            console.log('Fetched report managers:', data); // Add this to debug
                                                            var assignedToSelect = document.getElementById('assigned_to');
                                                            assignedToSelect.innerHTML =
                                                                '<option value="disable">- - -Select Report Manager- - -</option>'; // Clear previous options

                                                            if (data.reportManagers && data.reportManagers.length > 0) {
                                                                ...
                                                                option.textContent = 'No Report Managers Available';
                                                                assignedToSelect.appendChild(option);
                                                            }
                                                        })
                                                        .catch(error => {
                                                            console.error('Error fetching report managers:', error);
                                                        });
                                                }
                                            </script>
