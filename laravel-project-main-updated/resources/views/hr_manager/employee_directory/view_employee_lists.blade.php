                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="row mb-4">
                            ...
                            {{-- <div class="col-md-4 mb-3">
                                ...
                                <textarea class="form-control" readonly>{{ $test->permanent_address }}</textarea>
                            </div> --}}
                            ...
                            {{-- <div class="col-md-4 mb-3">
                                ...
                                <textarea class="form-control" readonly>{{ $test->current_address }}</textarea>
                            </div> --}}
                        ...
                        <div class="row mb-4">
                            ...
                            <div id="system-access">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" value="{{ $test->assigned_to }}" readonly>
                                </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('employee.list') }}" class="btn btn-primary px-4 py-2">Back to List</a>
                        </div>

                        {{-- <!-- Print Button -->
                        <button onclick="window.print()" class="btn btn-primary px-4 py-2 mt-3">Print</button> --}}
                    </div>
                </div>
            </div>
        </div>
