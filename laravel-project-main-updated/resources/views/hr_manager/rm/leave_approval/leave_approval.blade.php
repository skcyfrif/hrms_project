...
<div class="page-content">
    <h6 class="text-center">Report Managers Leave Approval</h6>
                            ...
                            <tbody>
                                @foreach($approvals as $key => $leave)
                                    <tr>
                                        ...
                                        <td>
                                            @if($leave->upload)
                                                <a href="{{ asset($leave->upload) }}" target="_blank" class="btn btn-inverse-info">View/Download</a>
                                            @else
                                                No file uploaded
                                            @endif
                                        </td>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        document.querySelectorAll(".rejectBtn").forEach(button => {
            button.addEventListener("click", function () {
                ...
                var rejectModal = new bootstrap.Modal(document.getElementById("rejectLeaveModal"));
                rejectModal.show();
            });
        });
    });
