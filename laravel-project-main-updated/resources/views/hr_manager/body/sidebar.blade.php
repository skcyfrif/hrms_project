<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item nav-category">HR Manager</li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link" data-bs-toggle="collapse" data-bs-target="#leaveManagementMenu" aria-expanded="false">
                    <i class="link-icon" data-feather="box"></i>
            ...
            <li class="nav-item">
                <a href="#" class="nav-link" data-bs-toggle="collapse" data-bs-target="#claimFormMenu" aria-expanded="false">
                    <i class="link-icon" data-feather="box"></i>
            ...
            <li class="nav-item">
                <a href="#" class="nav-link" data-bs-toggle="collapse" data-bs-target="#attendanceStatusMenu" aria-expanded="false">
                    <i class="link-icon" data-feather="box"></i>
            ...
            <li class="nav-item">
                <a href="#" class="nav-link" data-bs-toggle="collapse" data-bs-target="#pendingApprovalMenu" aria-expanded="false">
                    <i class="link-icon" data-feather="box"></i>
            ...
            <li class="nav-item">
                <a href="#" class="nav-link" data-bs-toggle="collapse" data-bs-target="#leaveApprovalMenu" aria-expanded="false">
                    <i class="link-icon" data-feather="box"></i>
            ...
            <li class="nav-item">
                <a href="#" class="nav-link" data-bs-toggle="collapse" data-bs-target="#claimApprovalMenu" aria-expanded="false">
                    <i class="link-icon" data-feather="box"></i>
                ...
                <ul class="collapse" id="claimApprovalMenu">
                    ...
                    <li class="nav-item">
                        <a href="{{route('rmclaimapproval.status')}}" class="nav-link">Reporting Manager Claim Approval</a>
                    </li>
                </ul>
            </li>
